          ...
          >
            <div class="task-item-top">
              ...
              <div class="task-item-actions">
                ...
                <button
                  v-if="t.status !== 'pending' && t.status !== 'running' && t.status !== 'reviewing' && t.status !== 'planning' && t.status !== 'subtask_running' && t.status !== 'merge_queued' && t.status !== 'integrating' && t.status !== 'conflict_resolution'"
                  class="archive-btn"
                  title="归档"
